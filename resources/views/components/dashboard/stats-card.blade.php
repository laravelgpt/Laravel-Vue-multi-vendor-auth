        ...
        <div class="flex items-center">
            <div class="flex-shrink-0">
                <div class="w-8 h-8 {{ $colorClasses[$color] }} rounded-md flex items-center justify-center">
                    ...
                    @elseif($icon === 'heroicon-o-users')
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"></path>
                        </svg>
                    @elseif($icon === 'heroicon-o-building-office')
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @elseif($icon === 'heroicon-o-wrench-screwdriver')
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655-5.653a2.548 2.548 0 01-.39-3.114L4.26 8.82a2.548 2.548 0 00-.39 3.114l4.655 5.653z"></path>
                        </svg>
                    @elseif($icon === 'heroicon-o-cog')
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="ml-5 w-0 flex-1">
                <dl>
                    ...
                    @if($change)
                        <dd class="text-sm {{ $changeColorClasses[$changeType] }}">
