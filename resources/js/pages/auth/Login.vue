...
import { Eye, EyeOff, Mail, Lock, Shield, Smartphone } from 'lucide-vue-next';
import { ref } from 'vue';
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-navy-100 dark:from-slate-900 dark:via-purple-900/20 dark:to-navy-900 flex items-center justify-center p-4">
        ...
        <Card class="w-full max-w-md glass-strong border border-purple-200/50 dark:border-purple-700/50 card-hover">
            <CardHeader class="space-y-1 text-center">
                ...
                <CardTitle class="text-3xl font-bold bg-gradient-to-r from-purple-600 via-navy-600 to-blue-600 bg-clip-text text-transparent">Welcome back</CardTitle>
            ...
            <CardContent class="space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            <label class="flex items-center space-x-2">
                                <input
                                    ...
                                    type="checkbox"
                                    class="rounded border-slate-300 text-purple-600 focus:ring-purple-500 dark:border-slate-600 dark:bg-slate-800"
                                />
                                <span class="text-sm text-slate-600 dark:text-slate-400">Remember me</span>
                            </label>
                            <TextLink href="/forgot-password" class="text-sm text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 font-medium">
                                Forgot password?
                            </TextLink>
                        </div>
                ...
                <div class="text-center">
                    ...
                    <TextLink href="/register" class="text-sm text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 font-medium">
                        Sign up
                    </TextLink>
                </div>
            </CardContent>
