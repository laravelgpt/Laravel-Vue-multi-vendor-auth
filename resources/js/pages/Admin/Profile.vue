...
<template>
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        ...
        <div class="absolute inset-0 overflow-hidden">
            <div class="absolute -top-40 -right-40 h-80 w-80 rounded-full bg-gradient-to-br from-purple-400/20 to-pink-600/20 blur-3xl"></div>
            <div class="absolute -bottom-40 -left-40 h-80 w-80 rounded-full bg-gradient-to-tr from-indigo-400/20 to-purple-600/20 blur-3xl"></div>
            <div class="absolute top-1/2 left-1/2 h-60 w-60 -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-purple-400/10 to-pink-600/10 blur-2xl"></div>
        </div>
            ...
            <div class="max-w-4xl mx-auto space-y-6">
                ...
                <div class="text-center animate-fade-in">
                    <div class="flex items-center justify-center space-x-3 mb-4">
                        <Crown class="w-8 h-8 text-purple-600 dark:text-purple-400" />
                        <h1 class="text-3xl font-bold text-slate-900 dark:text-white">Admin Profile</h1>
                    </div>
                    <p class="text-slate-600 dark:text-slate-400">Manage your administrator account settings and preferences</p>
                </div>

                <!-- Profile Overview Card -->
                <Card class="glass card-hover animate-bounce-in border-purple-200 dark:border-purple-800">
                    <CardContent class="p-6">
                        <div class="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6">
                            <div class="relative">
                                ...
                                <Button size="sm" variant="outline" class="absolute -bottom-2 -right-2 rounded-full w-8 h-8 p-0 border-purple-300 dark:border-purple-700">
                                    <Camera class="w-4 h-4" />
                                </Button>
                            </div>
                            <div class="flex-1 text-center sm:text-left">
                                <div class="flex flex-col sm:flex-row items-center sm:items-start space-y-2 sm:space-y-0 sm:space-x-3 mb-2">
                                    <h2 class="text-2xl font-bold text-slate-900 dark:text-white">{{ user?.name }}</h2>
                                    <div class="flex items-center space-x-2">
                                        <Badge variant="default" class="bg-gradient-to-r from-purple-600 to-pink-600 text-white">
                                ...
                                <div class="flex flex-col sm:flex-row items-center sm:items-start space-y-2 sm:space-y-0 sm:space-x-4 text-sm text-slate-500 dark:text-slate-400">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <!-- Profile Information -->
                    <Card class="glass card-hover animate-slide-in-left border-purple-200 dark:border-purple-800">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Update your administrator account's profile information and email address.
                            </CardDescription>
                        </CardHeader>
                    ...
                    <!-- Change Password -->
                    <Card class="glass card-hover animate-slide-in-right border-purple-200 dark:border-purple-800">
                        <CardHeader>
                            <CardTitle class="flex items-center space-x-2">
                            ...
                            <CardDescription>
                                Ensure your administrator account is using a long, random password to stay secure.
                            </CardDescription>
                        </CardHeader>
                        <CardContent class="space-y-4">
                            <div>
                ...
                <!-- Social Links -->
                <Card class="glass card-hover animate-fade-in border-purple-200 dark:border-purple-800">
                    <CardHeader>
                        <CardTitle class="flex items-center space-x-2">
                        ...
                        <CardDescription>
                            Add your social media profiles to your administrator account.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
