<template>
  <div class="min-h-screen bg-gradient-to-br from-purple-900 via-navy-800 to-blue-900 flex items-center justify-center p-4">
    ...
    <div class="relative z-10 text-center max-w-2xl mx-auto">
      <!-- Error Code -->
      <div class="mb-8">
        <h1 class="text-9xl font-bold bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 bg-clip-text text-transparent animate-bounce">
          401
        </h1>
      </div>
      ...
      <div class="mb-8 flex justify-center">
        <div class="relative">
          <div class="w-24 h-24 bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-full flex items-center justify-center shadow-2xl animate-pulse">
            <UserX class="w-12 h-12 text-white" />
          </div>
          <div class="absolute -top-2 -right-2 w-8 h-8 bg-red-400 rounded-full flex items-center justify-center animate-bounce">
            <Lock class="w-4 h-4 text-red-900" />
          </div>
        </div>
      </div>
      ...
      <div class="mb-8 p-6 bg-yellow-500/10 border border-yellow-500/20 rounded-2xl backdrop-blur-sm animate-fade-in-delay-2">
        <div class="flex items-center justify-center mb-3">
          <Shield class="w-5 h-5 text-yellow-400 mr-2" />
          <span class="text-yellow-400 font-semibold">Authentication Required</span>
        </div>
        <p class="text-gray-300 text-sm">
          This page requires valid authentication. Please sign in or contact support if you believe this is an error.
        </p>
      </div>
