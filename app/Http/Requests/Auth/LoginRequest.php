...
class LoginRequest extends FormRequest
{
    ...
    public function authenticate(): void
    {
        ...
        $loginField = filter_var($this->get('login'), FILTER_VALIDATE_EMAIL) ? 'email' : 'username';

        if (! Auth::attempt([$loginField => $this->get('login'), 'password' => $this->get('password')], $this->boolean('remember'))) {
